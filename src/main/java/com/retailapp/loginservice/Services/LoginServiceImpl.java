...
public LoginServiceImpl(UserDao loginDao, JwtFilter jwtFilter, JwtUtill jwtUtill) {
		super();
...
//	}
	...
	return new ResponseEntity<String>("{\"message\":\""+"User not Registered."+"\"}",HttpStatus.INTERNAL_SERVER_ERROR);		
	}
